...
const events: WeddingEvent[] = [
  {
    ...
    note: 'Theme: Hawaiian. Please wear floral clothing — and be prepared for water guns!',
  },
  {
    icon: '🌸',
    name: 'Mehndi',
  ...
  },
  {
    ...
    address: 'Ahmedabad, Gujarat',
    note: 'Dress code: cocktail attire — bring your bling and your dancing shoes.',
  },
  {
    icon: '✨',
